...
What's the goal here? The goal is to Balance Challenge and Skill to get into flow. [[Main/Umami/Balancing Challenge and Skill]] is basically the meta-meta-skill. On a conceptual level, that's what we're always trying to do when we're going after high quality experiences in life.

Here are the mental steps—the meta-skills—surrounding conscious flowcreation:

1. Awareness of your current state
2. Creating the [[Main/Umami/Conditions of Flow]]
3. Maintain your Flow — Check out the [[Main/Umami/Four Factors of Flow]] and learn how you can use these factors to govern and control the levers of flow.
